    ...
    <section class="testimonials">
      <div class="container">
        ...
        <div class="testimony-wrapper">
          <div class="testimony-card" data-aos="zoom-up"
        data-aos-offset="20"
        data-aos-easing="ease-in"
        data-aos-mirror="true"
        data-aos-once="false"
        data-aos-anchor-placement="top-center">
            <div class="test-img">
              <img src="../assets/Icons/user1.svg" alt="" />
            </div>
            <p>
              <b> Wow the company I know!</b> Lorem ipsum dolor sit amet,
              consectetur adipiscing elit.
            </p>
            <h3>- Getachew Bezuwerk</h3>
          </div>
          <div class="testimony-card" data-aos="zoom-up"
        data-aos-offset="20"
        data-aos-easing="ease-in"
...
export default {
  ...
  mounted() {
    ...
    <source media="(min-width:650px)" srcset="../assets/Icons/logo.svg">
        ...
        logo.innerHTML = `<picture>
    <source media="(min-width:650px)" srcset="../assets/Icons/logo2.svg">
